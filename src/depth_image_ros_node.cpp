    ...
    : nh_(nh), pnh_(pnh), it_(nh_)
{
    ...
    pnh_.param<std::string>("depth_image_topic", depth_image_topic_, std::string("/odin1/depth_img_completion"));
    pnh_.param<std::string>("depth_cloud_topic", depth_cloud_topic_, std::string("/odin1/depth_img_completion_cloud"));
